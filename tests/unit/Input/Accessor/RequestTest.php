...
namespace Flair\Input\Accessor {
	 ...
	 * @coversDefaultClass \Flair\Input\Accessor\Request
	...
	class RequestTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			$_REQUEST['testInput'] = 'testInputValue';

			self::$obj = new Request('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Request', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Request variable does not exist', $e->getMessage());
				return;
			}
