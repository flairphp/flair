...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the Cookie class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\Cookie
	...
	class CookieTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			$_COOKIE['testInput'] = 'testInputValue';

			self::$obj = new Cookie('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Cookie', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Cookie variable does not exist', $e->getMessage());
				return;
			}
