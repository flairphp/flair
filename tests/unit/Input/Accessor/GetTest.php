...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the Get class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\Get
	...
	class GetTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			$_GET['testInput'] = 'testInputValue';

			self::$obj = new Get('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Get', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Get variable does not exist', $e->getMessage());
				return;
			}
