...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the Argv class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\Argv
	...
	class ArgvTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			global $argv;
			$argv['testInput'] = 'testInputValue';

			self::$obj = new Argv('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Argv', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Argv variable does not exist', $e->getMessage());
				return;
			}
