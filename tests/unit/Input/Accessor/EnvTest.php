...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the Env class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\Env
	...
	class EnvTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			$_ENV['testInput'] = 'testInputValue';

			self::$obj = new Env('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Env', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Env variable does not exist', $e->getMessage());
				return;
			}
