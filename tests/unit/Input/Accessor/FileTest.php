...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the File class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\File
	...
	class FileTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			$_FILES['testInput'] = 'testInputValue';

			self::$obj = new File('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\File', self::$obj, $msg);
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The File variable does not exist', $e->getMessage());
				return;
			}
