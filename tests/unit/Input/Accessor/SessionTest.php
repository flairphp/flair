...
namespace Flair\Input\Accessor {
	...
	/**
	 * The Unit test for the Session class.
	 *
	 * @author Daniel Sherman
	 * @coversDefaultClass \Flair\Input\Accessor\Session
	...
	class SessionTest extends \PHPUnit\Framework\TestCase {
		...
		public static function setUpBeforeClass() {
			self::$obj = new Session('testInputNone');
		}
		...
		public function testConstruct() {
			...
			$this->assertInstanceOf('Flair\Input\Accessor\Session', self::$obj, $msg);
		...
		public function testExists() {
			...
			$_SESSION['testInput'] = 'testInputValue';
		...
		public function testGetException() {
			...
			try {
				...
				$this->assertEquals('The Session variable does not exist', $e->getMessage());
				return;
			}
			session_write_close();
