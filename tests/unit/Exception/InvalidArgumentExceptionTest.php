...
namespace Flair\Exception {
    ...
    class InvalidArgumentExceptionTest extends \PHPUnit_Framework_TestCase
    {
        ...
        protected function thrower($multi = false)
        {
            ...
            if ($multi) {
                $grandParent = new InvalidArgumentException('grandParent', 0);
                $previous = new InvalidArgumentException('parent', 1, $grandParent);
            } else {
        ...
        public function testConstruct()
        {
            ...
            $this->assertInstanceOf('Flair\Exception\InvalidArgumentException', $exception, $msg);
