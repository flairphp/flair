...
namespace Flair\Exception {
    ...
    class LogicExceptionTest extends \PHPUnit_Framework_TestCase
    {
        ...
        {
            try {
                throw new LogicException(self::$msg, self::$code, null, self::$context);
            } catch (\Exception $e) {
                return [[$e]];
            }
        }
        ...
        {
            $previous = new LogicException('parent', 1);
        ...
        public function testConstruct($e)
        {
            ...
            $this->assertInstanceOf('Flair\Exception\LogicException', $e, $msg);
